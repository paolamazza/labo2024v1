...
envg$EXPENV <- list()
envg$EXPENV$exp_dir <- "~/buckets/b1/exp/Under_0.55"
envg$EXPENV$wf_dir <- "~/buckets/b1/flow/Under_0.55"
...
TS_strategy_guantesblancos_202109 <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$train$undersampling <- 0.55
...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  ZZ_final_guantesblancos( "ZZ0001_extra", c("HT0001","TS0001") )
...
corrida_guantesblancos_202109( "gb01_extra" )
